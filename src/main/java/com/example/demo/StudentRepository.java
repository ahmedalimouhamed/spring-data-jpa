...
public interface StudentRepository extends PagingAndSortingRepository<Student, Long> {
    ...
    List<Student>selectStudentWhereNameAndAgeGreatesOrEqualNative(String firstName, Integer age);
    @Query(value = "SELECT * FROM student WHERE first_name = :firstName AND age >= :age", nativeQuery = true)
    List<Student>selectStudentWhereNameAndAgeGreatesOrEqualNativeParam(@Param("firstName") String firstName, @Param("age") Integer age);
    @Transactional
    @Modifying
